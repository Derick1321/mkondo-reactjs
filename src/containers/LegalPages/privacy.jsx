      ...
      <div className="page">
        <div className="header">
          <div className="container">
              <Link to={routePaths.marketing}>Back to Mkondo</Link>
              <MkondoLogo />
            <h1 className="title">Privacy Policy for Mkondo</h1>
          </div>
        </div>
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Peach Technology Corporation, Delano, MN.
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Mkondo, accessible from{" "}
                    <a
                      href="www.mkondo.co"
...
n over the Internet, orimport { Link, useHistory } from 'react-router-dom';
              ...
              <ul>
                <li>
                  <p>By email: support@mkondo.co</p>
                </li>
                <li>
                  <p>
                    By visiting this page on our website:{" "}
                    <a
                      href="https://mkondo.co/privacy"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://mkondo.co/privacy
                    </a>
                  </p>
                </li>
                <li>
                  <p>By phone number: +255659702633</p>
                </li>
              </ul>
            </div>
          </div>
